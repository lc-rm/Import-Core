  ...
  jobcore: {
    ...
    map: (row, ctx) => {
      ...
      return {
        ...
        '勤務地':   get('求人_勤務地名称') || get('掲載店舗') || get('店舗名'),
        '部署':     get('掲載社名') || get('店舗名'),
        '名前':     get('氏名'),
        'ふりがな': get('氏名かな'),
  ...
  engage: {
    ...
    map: (row, ctx) => {
      ...
      return {
        ...
        '求人番号': get('求人管理番号') || get('応募求人-求人ID'),
        '求人名称': get('応募求人-職種名'),
        '応募職種': get('現在の経験職種') || get('応募求人-職種名'),
        '勤務地':   get('希望勤務地') || ctx.norm(get('都道府県')),
        '部署':     '',
