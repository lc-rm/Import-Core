...
// ----- 行ハッシュ用ヘッダー(人を特定する最小限の項目) -----
// 採用コア側で更新される項目(ステータス・面接結果等)はもちろん、
// 媒体側で変動する項目(求人番号・メモ・部署等)も除外することで、
// 「同じ応募日・同じ人」が別ハッシュになる誤検出を防ぐ。
//
// 含める項目: 応募日・求人名称・名前・メール・電話・生年月日・媒体名
// → 「同じ人・同じ日・同じ求人・同じ媒体」だけを「同一データ」とみなす
//   別の日 / 別の求人 / 別媒体 / 別人 → 別データ
//
// 注:求人番号は媒体仕様変更等で変動しやすいので含めない(求人名称で識別)
const HASH_HEADERS = [
  "応募日","求人名称","名前","メール","電話","生年","月","日","媒体名"
];
